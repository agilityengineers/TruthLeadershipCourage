...
export const metadata = { title: "Completion certificate" };
        ...
        <div className="relative overflow-hidden rounded-[18px] border-[6px] border-double border-[#262161] bg-white p-12 text-center shadow-card">
          ...
          <div className="relative">
            <div className="mb-6 flex justify-center">
              <Image src="/brand/wisdomtri-logo.jpg" alt="The Wisdom Tri" width={72} height={72} className="h-[72px] w-[72px] object-contain" />
            </div>

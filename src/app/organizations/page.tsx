...
export const metadata: Metadata = {
  title: "TLC for Organizations",
  description:
    "Build leaders worth following at every level, so your company executes like one. A six-month leadership operating system, delivered as a private cohort for your team.",
};
    ...
    <div className="bg-white text-ink">
      ...
      <footer className="border-t border-[#eef0f5] bg-white">
        <div className="shell flex flex-wrap items-center gap-3.5 py-[34px]">
          <Image src="/brand/wisdomtri-logo.jpg" alt="" width={40} height={40} className="h-10 w-10 object-contain" />

...
export function LeadershipModel({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <text x={300} y={272} fill="#ffffff" fontStyle="italic" fontWeight="700" fontSize="38" fontFamily="var(--app-font-display), sans-serif">EQ</text>
      ...
      <text x={470} y={272} fill="#ffffff" fontStyle="italic" fontWeight="700" fontSize="38" fontFamily="var(--app-font-display), sans-serif">IQ</text>
      ...
      <text x={388} y={430} fill="#ffffff" fontStyle="italic" fontWeight="700" fontSize="40" fontFamily="var(--app-font-display), sans-serif">MQ</text>
      <text x={446} y={414} fill="#ffffff" fontWeight="600" fontSize="15" fontFamily="var(--app-font-display), sans-serif">TM</text>

      {/* ELQ core label + figure */}
      <text x={360} y={312} textAnchor="middle" fill="#ffffff" fontWeight="700" fontSize="20" fontFamily="var(--app-font-display), sans-serif">
        ELQ
      ...
      {/* nine ring labels */}
      <g fill={LABEL_INK} fontFamily="var(--app-font-eyebrow), sans-serif" fontWeight="600" fontSize="17">
        {LABELS.map((l) => (
          <text
            key={l.text}
            x={l.x}
